"""Based on https://github.com/Beckschen/TransUNet/blob/d68a53a2da73ecb496bb7585340eb660ecda1d59/networks/vit_seg_modeling_resnet_skip.py#L112"""
...
class ResNetV2(nn.Module):
    ...
    def __init__(self, block_units, width_factor):
        ...
        self.root = nn.Sequential(OrderedDict([
            ('conv', StdConv2d(1, width, kernel_size=7, stride=2, bias=False, padding=3)), # there was 1 at beginign
